...
ghostty_palette_color_2="#ddeecc"
ghostty_palette_color_3="#99bbaa"
...
ghostty_palette_color_10="#ddeecc"
ghostty_palette_color_11="#99bbaa"
...
cat <<EOF
# vim: ft=ghostty
# Black Metal (Burzum) theme for Ghostty
