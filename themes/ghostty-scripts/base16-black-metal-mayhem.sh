...
ghostty_palette_color_2="#f3ecd4"
ghostty_palette_color_3="#eecc6c"
...
ghostty_palette_color_10="#f3ecd4"
ghostty_palette_color_11="#eecc6c"
...
cat <<EOF
# vim: ft=ghostty
# Black Metal (Mayhem) theme for Ghostty
