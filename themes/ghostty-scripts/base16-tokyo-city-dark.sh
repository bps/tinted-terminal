...
ghostty_palette_color_3="#b7c5d3"
ghostty_palette_color_4="#7aa2f7"
ghostty_palette_color_5="#bb9af7"
ghostty_palette_color_6="#89ddff"
...
cat <<EOF
# vim: ft=ghostty
# Tokyo City Dark theme for Ghostty
