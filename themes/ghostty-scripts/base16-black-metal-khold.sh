...
ghostty_palette_color_2="#eceee3"
ghostty_palette_color_3="#974b46"
...
ghostty_palette_color_10="#eceee3"
ghostty_palette_color_11="#974b46"
...
cat <<EOF
# vim: ft=ghostty
# Black Metal (Khold) theme for Ghostty
