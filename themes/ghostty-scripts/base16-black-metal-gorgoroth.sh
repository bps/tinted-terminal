...
ghostty_palette_color_2="#9b8d7f"
ghostty_palette_color_3="#8c7f70"
...
ghostty_palette_color_10="#9b8d7f"
ghostty_palette_color_11="#8c7f70"
...
cat <<EOF
# vim: ft=ghostty
# Black Metal (Gorgoroth) theme for Ghostty
