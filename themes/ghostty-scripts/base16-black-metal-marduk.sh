...
ghostty_palette_color_2="#a5aaa7"
ghostty_palette_color_3="#626b67"
...
ghostty_palette_color_10="#a5aaa7"
ghostty_palette_color_11="#626b67"
...
cat <<EOF
# vim: ft=ghostty
# Black Metal (Marduk) theme for Ghostty
